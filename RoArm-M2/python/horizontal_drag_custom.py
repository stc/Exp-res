...
def draw_axis():
    ...
    canvas.create_text(center_x + 8, 12, text="X+", fill=line_color, anchor='w')
...
slider_label = customtkinter.CTkLabel(canvas_frame, text=" Z-AXIS VALUE: %d"%slider_value, fg_color="transparent")
slider_label.grid(row=11, column=0, padx=10, pady=0, sticky="w")

slider = customtkinter.CTkSlider(canvas_frame, from_=-200, to=400, command=slider_event)
...
placeholder_8_label = customtkinter.CTkLabel(canvas_frame, text="6.You can mainpulate the horizontal plane movement of the robotic arm by scrolling the mouse wheel.", wraplength=300, justify="left", fg_color="transparent")
